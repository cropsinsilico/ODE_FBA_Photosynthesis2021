...
for p in PPFD:
    ...
    import os
    os.rename("./../FBA/Daytime_flux.csv","./../Validations/TC_FBAfluxes_Fig2B_"+str(p)+".csv")
    os.rename("./../ePhotosynthesis/OutputFluxT.txt","./../Validations/TC_ODEfluxes_Fig2B_"+str(p)+".csv")
