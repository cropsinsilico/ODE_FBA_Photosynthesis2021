...
Data_PPFD = {0:20.83333333,2.6:260.4166667,5.2:989.5833333,8.1:1302.083333,
             10.3:1020.833333,12.6:260.4166667,14.1:10.41666667}
...
for p in PPFD:
    ...
    import os
    os.rename("./../FBA/Daytime_flux.csv","./../Validations/Daytime_flux_FACE205_372_"+str(j)+".csv")
    os.rename("./../ePhotosynthesis/OutputFluxT.txt","./../Validations/OutputFluxT_FACE205_372_"+str(j)+".csv")
...
import os
os.rename("./../FBA/Nighttime_flux.csv","./../Validations/Nighttime_flux_FACE205_372.csv")
