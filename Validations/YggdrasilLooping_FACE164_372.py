...
Data_PPFD = {0:33.33333333,2.4:716.6666667,4.7:1616.666667,6.8:1650,
             9:1550,11.2:1516.666667,13.3:1166.666667,15.8:25}
...
for p in PPFD:
    ...
    import os
    os.rename("./../FBA/Daytime_flux.csv","./../Validations/Daytime_flux_FACE164_372_"+str(j)+".csv")
    os.rename("./../ePhotosynthesis/OutputFluxT.txt","./../Validations/OutputFluxT_FACE164_372_"+str(j)+".csv")
...
import os
os.rename("./../FBA/Nighttime_flux.csv","./../Validations/Nighttime_flux_FACE164_372.csv")
