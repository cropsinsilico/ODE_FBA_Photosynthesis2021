...
Data_PPFD = {0:10.41666667,1.9:291.6666667,3.8:1000,6:1614.583333,
             7.9:1802.083333,9.8:1677.083333,12:864.5833333,13.9:208.3333333,
             15.7:10.41666667}
...
for p in PPFD:
    ...
    import os
    os.rename("./../FBA/Daytime_flux.csv","./../Validations/Daytime_flux_FACE176_552_"+str(j)+".csv")
    os.rename("./../ePhotosynthesis/OutputFluxT.txt","./../Validations/OutputFluxT_FACE176_552_"+str(j)+".csv")
...
import os
os.rename("./../FBA/Nighttime_flux.csv","./../Validations/Nighttime_flux_FACE176_552.csv")
