...
for ppfd in PPFD:
    ...
    import os
    os.rename("./../FBA/Diel_flux.csv","./../Validations/LC_FBAfluxes_Fig2B_"+str(ppfd)+".csv")
    os.rename("./../ePhotosynthesis/OutputFluxT.txt","./../Validations/LC_ODEfluxes_Fig2B_"+str(ppfd)+".csv")
