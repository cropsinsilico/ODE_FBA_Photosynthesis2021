...
Data_PPFD = {0:9.278350515,2.2:629.3417922,4.5:1527.835052,7:1694.528152,
             9.1:1531.007137,11.2:1181.919112,13.4:18.47739889}
...
for p in PPFD:
    ...
    import os
    os.rename("./../FBA/Daytime_flux.csv","./../FBA/Daytime_flux_FACE254_552_"+str(j)+".csv")
...
import os
os.rename("./../FBA/Nighttime_flux.csv","./../FBA/Nighttime_flux_FACE254_552.csv")
