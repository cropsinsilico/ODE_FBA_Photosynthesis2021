...
% EDIT STARTED suggested by Yu to get around high ATPase and NADPHox resulting in error when values used directly at t=0
global setATPCost
global TestATPCost;
global setNADPHCost;
global TestNADPHCost;
if t<100&&setNADPHCost>4
   TestNADPHCost=setNADPHCost/100*t;
   TestATPCost=setATPCost/100*t;
else
   TestNADPHCost=setNADPHCost;
   TestATPCost=setATPCost;
end
% EDIT FINISHED
